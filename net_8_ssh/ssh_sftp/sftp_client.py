...
if __name__ == '__main__':
    # 使用Linux解释器 & WIN解释器
    # ssh_sftp_put('10.1.1.180', 'root', 'Cisc0123', './file_dir/upload_file.txt', 'upload_file.txt', port=22)
    ssh_sftp_get('10.1.1.180', 'root', 'Cisc0123', 'upload_file.txt', './file_dir/download_file.txt', port=22)
